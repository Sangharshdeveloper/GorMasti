package com.masti.shortvideoapp.SimpleClasses;
...
import com.masti.shortvideoapp.ActivitesFragment.CustomErrorActivity;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.Constants;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.rtc.AgoraEventHandler;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.rtc.EngineConfig;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.rtc.EventHandler;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.stats.StatsManager;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.utils.FileUtil;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.utils.PrefManager;
import com.masti.shortvideoapp.ActivitesFragment.Profile.Setting.NoInternetA;
import com.masti.shortvideoapp.Interfaces.InternetCheckCallback;
...
import static com.masti.shortvideoapp.SimpleClasses.ImagePipelineConfigUtils.getDefaultImagePipelineConfig;
...
public class TicTic extends Application implements Application.ActivityLifecycleCallbacks, BackgroundDetectorHandler.OnVisibilityChangedListener {
    ...
    public void onCreate() {
        ...
        if (exoDatabaseProvider != null) {
            exoDatabaseProvider = new ExoDatabaseProvider(getApplicationContext());
        }
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"))
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Log.d(com.masti.shortvideoapp.Constants.tag,"removeOnlineStatus: "+Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"));
                };
            });
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            ...
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0")).setValue(onlineModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Log.d(com.masti.shortvideoapp.Constants.tag,"addOnlineStatus: "+onlineModel.getUserId());
                        };
                    });
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        Log.d(com.masti.shortvideoapp.Constants.tag,"token: "+token);
    ...
    {
        Log.d(com.masti.shortvideoapp.Constants.tag,"onAppGoesToBackground");
        removeOnlineListener();
    }
    ...
    {
        Log.d(com.masti.shortvideoapp.Constants.tag,"onAppGoesToForeground");
        addOnlineListener();
    }
