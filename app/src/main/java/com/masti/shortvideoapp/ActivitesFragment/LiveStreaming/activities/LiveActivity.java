package com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.activities;
...
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveCommentModel;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveCommentsAdapter;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveUserViewAdapter;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.stats.LocalStatsData;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.stats.RemoteStatsData;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.stats.StatsData;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.ui.VideoGridContainer;
import com.masti.shortvideoapp.ActivitesFragment.SendGift.StickerGiftF;
import com.masti.shortvideoapp.ActivitesFragment.SendGift.StickerModel;
import com.masti.shortvideoapp.ApiClasses.ApiLinks;
import com.masti.shortvideoapp.Models.StreamShowHeartModel;
import com.masti.shortvideoapp.Models.UserOnlineModel;
import com.masti.shortvideoapp.SimpleClasses.OnSwipeTouchListener;
import com.masti.shortvideoapp.SimpleClasses.StreamingLikes.HeartView;
...
public class LiveActivity extends RtcBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(com.masti.shortvideoapp.Constants.STREAMING_LIMIT)
        {
            try {
               if (userRole == Constants.CLIENT_ROLE_BROADCASTER)
               {
                   ...
                   },com.masti.shortvideoapp.Constants.MAX_STREMING_TIME);
               }
            }
            catch (Exception e)
            {
                Log.d(com.masti.shortvideoapp.Constants.tag,"Exception streaming : "+e);
            }
        }
    }
        ...
        joinValueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    {
                        Log.d(com.masti.shortvideoapp.Constants.tag,"Data JSON : "+joinSnapsot.getValue().toString());
    ...
    private void initUI() {
        ...
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "initUI");
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initUserIcon() {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "initUserIcon");
    ...
    private void initData() {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "initData");
        mVideoDimension = com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.masti.shortvideoapp.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "renderRemoteUser");
    ...
    public void onRtcStats(IRtcEngineEventHandler.RtcStats stats) {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "onRtcStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onNetworkQuality(int uid, int txQuality, int rxQuality) {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "onNetworkQuality");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteVideoStats(IRtcEngineEventHandler.RemoteVideoStats stats) {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "onRemoteVideoStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.masti.shortvideoapp.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
        ...
        if (streamerConnectCheckListener ==null)
        {
            ...
            streamerConnectCheckListener =new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        Log.d(com.masti.shortvideoapp.Constants.tag, "connected");
                        streamerTimer.cancel();
                    } else {
                        Log.d(com.masti.shortvideoapp.Constants.tag, "not connected");
                        streamerTimer.cancel();
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Log.w(com.masti.shortvideoapp.Constants.tag, "Listener was cancelled");
                }
            };
