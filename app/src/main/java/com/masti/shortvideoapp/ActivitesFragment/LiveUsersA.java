...
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveUserAdapter;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.activities.LiveActivity;
...
import com.masti.shortvideoapp.SimpleClasses.TicTic;
...
public class LiveUsersA extends AppCompatLocaleActivity implements View.OnClickListener {
        ...
        valueEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.exists())
                {
                    ...
                    if (model.getUser_id()!=null && !(TextUtils.isEmpty(model.getUser_id())) && !(TextUtils.isEmpty(model.getUser_id())) && !(model.getUser_id().equals("null")))
                    {
                        dataList.add(model);
    ...
    public void openTicTicLive(String userId, String userName, String userImage, int role) {
        ...
        intent.putExtra(com.masti.shortvideoapp.ActivitesFragment.LiveStreaming.Constants.KEY_CLIENT_ROLE, role);
