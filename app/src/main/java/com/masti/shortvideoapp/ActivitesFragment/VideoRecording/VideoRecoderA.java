package com.masti.shortvideoapp.ActivitesFragment.VideoRecording;
...
import com.masti.shortvideoapp.Interfaces.ProgressBarListener;
import com.masti.shortvideoapp.SimpleClasses.SegmentedProgressBar;
...
import com.masti.shortvideoapp.ActivitesFragment.SoundLists.SoundListMainA;
import com.googlecode.mp4parser.authoring.Movie;
import com.googlecode.mp4parser.authoring.Track;
import com.googlecode.mp4parser.authoring.builder.DefaultMp4Builder;
import com.googlecode.mp4parser.authoring.container.mp4.MovieCreator;
import com.googlecode.mp4parser.authoring.tracks.AppendTrack;
import com.masti.shortvideoapp.TrimModule.TrimType;
import com.masti.shortvideoapp.TrimModule.TrimVideo;
import com.masti.shortvideoapp.TrimModule.TrimmerUtils;
    ...
    public void startOrStopRecording() {
        ...
        if (!isRecording && secPassed < (Constants.RECORDING_DURATION / 1000) - 1) {
          ...
          catch (Exception e)
          {
            ...
            Functions.showAlert(getApplicationContext(), getString(R.string.alert), getString(R.string.video_only_can_be_a)+" " + (int) Constants.RECORDING_DURATION / 1000 + " S");
        }
     ...
     try {
         ...
         if (videopaths.size() > 0) {
             ...
             if (file.exists()) {
                 ...
                 long timeInMillisec = Long.valueOf(time);
                 boolean isVideo = "yes".equals(hasVideo);
                 if (isVideo) {
