...
public class Constants {
    ...
    private static final float BEAUTY_EFFECT_DEFAULT_LIGHTNESS = 0.9f;
    private static final float BEAUTY_EFFECT_DEFAULT_SMOOTHNESS = 0.8f;
    private static final float BEAUTY_EFFECT_DEFAULT_REDNESS = 0.6f;
