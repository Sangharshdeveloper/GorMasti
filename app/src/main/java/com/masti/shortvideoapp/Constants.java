package com.masti.shortvideoapp;

public class Constants {

    public static final String BASE_URL = "http://mastiapp.in/mobileapp_api/";
    public static final String API_KEY  = "156c4675-9608-4591-1111-00000";
    public static final String privacy_policy =   "https://swiftsoftix.com/privacypolicy.html";
    public static final String terms_conditions = "https://swiftsoftix.com/terms.html";
